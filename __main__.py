...
from src.error import Codes, Error
from src.networking import Server, Client
from src.crypt import AES, RSA
...
def main():
	...
	initPacket = Packet(Packet.methodFromString("QUERY_DATA"))
	initPacket.addData("$test")
	genPacket = Packet.new(initPacket.getPackettString())
	print(initPacket.toPrint())
	print(genPacket)
	'''
